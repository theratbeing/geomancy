...
# Change how the figures are placed in house chart. Use either 'normal' or 'agrippa'.
HOUSE_SYSTEM = 'normal'
...
# Default log file name and line ending. For line ending use either 'windows' or 'unix'
LOG_DEFAULT_NAME = 'geomancy.log'
LOG_NEWLINE = 'unix'
